          ...
          builder: (context,snapshot){
            if (snapshot.hasError) {
              ...
              return ListView.builder(
                reverse: true,
                shrinkWrap: true,
                itemBuilder: (context,index)=>Noti_items(index,snapshot),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Text((documentSnapshot != null) ? (documentSnapshot["text"]) : "",
            style: TextStyle(color: Colors.white70, fontSize: 15,fontWeight: FontWeight.w200),
