...
class reg_events extends StatefulWidget {
  const reg_events({Key? key}) : super(key: key);

  @override
  State<reg_events> createState() => _eventsState();
}

class _eventsState extends State<reg_events> {
